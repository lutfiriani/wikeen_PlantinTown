...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-body">
                <form method="POST" action="{{ route('tanaman-utara-update',$data->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div style="display:flex; text-align:left;">
                        <span style="text-align:left;"><img src="{{url('assets/tanaman-utara/'.$data->foto)}}" alt="" width="150px">
                    </div>
